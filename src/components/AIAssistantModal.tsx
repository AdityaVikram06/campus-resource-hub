                  ...
                  <div className="space-y-2.5">
                    {matches.map((match, idx) => (
                      ...
                      >
                        ...
                        {/* Open at Page Action Button */}
                        <button
                          id={`ai-open-match-${idx}-btn`}
                          onClick={() => handleOpenPage(match)}
                          className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-[#60B5FF] text-[#FFFFFF] hover:bg-[#4ea5ef] transition-all flex-shrink-0 cursor-pointer shadow-xs"
                        >
                          <BookOpen className="w-3.5 h-3.5" />
                          <span>Open at Page {match.page_number}</span>
